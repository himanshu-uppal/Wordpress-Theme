...
class Second_Footer_Widget extends WP_Widget {

    function __construct() {
        // Instantiate the parent object
        $widget_ops = array(
            'classname' => 'Second_Footer_Widget',
            'description' => 'Second_Footer_Widget',
        );
        parent::__construct( 'second_footer_widget', 'Second Footer Widget', $widget_ops );
...
add_action( 'widgets_init', 'second_footer_register_widgets' );
function second_footer_register_widgets() {
    register_widget( 'Second_Footer_Widget' );
}?>