...
class Third_Footer_Widget extends WP_Widget {

    function __construct() {
        // Instantiate the parent object
        $widget_ops = array(
            'classname' => 'Third_Footer_Widget',
            'description' => 'Third_Footer_Widget',
        );
        parent::__construct( 'third_footer_widget', 'Third Footer Widget', $widget_ops );
...
add_action( 'widgets_init', 'third_footer_register_widgets' );
function third_footer_register_widgets() {
    register_widget( 'Third_Footer_Widget' );
}?>