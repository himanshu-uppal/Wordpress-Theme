...
class First_Footer_Widget extends WP_Widget {

    function __construct() {
        // Instantiate the parent object
        $widget_ops = array(
            'classname' => 'First_Footer_Widget',
            'description' => 'First_Footer_Widget',
        );
        parent::__construct( 'first_footer_widget', 'First Footer Widget', $widget_ops );
...
add_action( 'widgets_init', 'first_footer_register_widgets' );
function first_footer_register_widgets() {
    register_widget( 'First_Footer_Widget' );
}?>